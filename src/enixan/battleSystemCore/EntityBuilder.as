    ...
    public class EntityBuilder {
        ...
        public static function buildEntity(buildData:EntityVO):IComponent {
            ...
            try {
                ...
                if (assetClass == null) {
                    trace("#>>BuildError! Class type of \"" + buildData.behaviourClassName + "\" is null! Operation denied.");
                    return null;
            ...
            if (component is Container && buildData.children) {
                ...
                if (component is Entity && buildData.behaviourClassName) {
                    ...
                    try {
                        ...
                        if (assetClass == null){
                            trace("#>>BuildError! Behaviour class type of \"" + buildData.behaviourClassName + "\" is null! Operation denied.");
                            return component;
                        } else if (err.errorID == 1034) {
                            trace("#>>BuildError! Behaviour class type of \"" + buildData.behaviourClassName + "\" dont implements IBehaviourManager! Operation denied.");
                            return component;
                        }
                        throw err;
                    }
